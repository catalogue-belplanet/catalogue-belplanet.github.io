...
viewOpts = ({title:1, page:1, zoom:1, fs:1, pdf:0, toc:NaN, thumbs:1, progress:0, showbar:1, bg:"#000", loadText:"loading content...", footer:1});
...
function addNavProps(){
	if(nav.numPages === undefined) nav.numPages=62;
